...
independently of the pre-existing margin m and of the cell c.  scripts/margin_model.py checks corr(delta, m)
...
Margins follow scripts/margin_model.py exactly: condition 0 = VT, 1 = V, 2 = T; margin = gold - best other;
an item is solvable in its grounded modality iff that margin > 0; it flips iff margin_VT < 0.

Offline, CPU only.

    python scripts/perturbation_invariance.py
"""
