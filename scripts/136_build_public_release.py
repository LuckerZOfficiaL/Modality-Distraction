...
Supersedes scripts/107_build_release.py. Differences that matter:
  ...
  * dataset card       README.md carries HF YAML frontmatter (license, configs, task categories)
    ...
    python scripts/136_build_public_release.py            # -> data/public_release/
    python scripts/136_build_public_release.py --check    # verify an existing tree, write nothing
"""
