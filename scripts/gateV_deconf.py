...
scripts/gated_patch_probe.py found that a probe predicting VISION-GROUNDING makes the h_V patch look deployable
...
We test on the matched-question de-confounded variant, which was built to drive a
...
Offline, CPU only.
    ...
    python scripts/gateV_deconf.py
"""
