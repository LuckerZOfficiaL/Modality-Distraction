...
vision-grounded items and destroy text-grounded ones. This script measures both sides.
    ...
    python scripts/universal_patch.py --model qwen --layer 28 --splits val,test
"""
import argparse
...
_spec = importlib.util.spec_from_file_location(
    "_d87", Path(__file__).parent / "dense_control.py")
...
def main():
    ...
    _s56 = importlib.util.spec_from_file_location(
        "_s56", Path(__file__).parent / "causal_ablation.py")
