...
Part A (cell level, 30 cells from scripts/grounding_strength.py): does distraction ~ grounding generalize
...
Offline. cf-stores discovered under data/activations/*/{cf-subdir} (uniform name dm_multidomain_v1_cf).
    ...
    python scripts/grounding_law_robustness.py                                          # D_M
    python scripts/grounding_law_robustness.py --pool assembled --cf-subdir merged_aokvqa_racehigh_cf
"""
