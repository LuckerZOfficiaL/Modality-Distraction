...
Families:
  qwen  : Qwen2.5-VL / Qwen2-VL (qwen_vl_utils + process_vision_info)
    ...
    CUDA_VISIBLE_DEVICES=0 python scripts/78_benchmark_capability.py --model qwen2.5-vl-3b \
        --benchmark mmstar --key qwen3b_base
    CUDA_VISIBLE_DEVICES=0 python scripts/78_benchmark_capability.py --model llavanext \
