...
Unlike scripts/behavioral_eval.py (single forward pass, letter-logit argmax), CoT requires GENERATION:
...
for the CoT instruction, so the comparison isolates the reasoning directive.
  ...
  CUDA_VISIBLE_DEVICES=0 .venv/bin/python scripts/cot_baseline.py --model qwen3b --pool both
  # smoke: --limit 20
"""
